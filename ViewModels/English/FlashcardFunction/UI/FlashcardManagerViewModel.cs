...
using LaboratoryApp.Views.English.FlashcardFunction.SubWin;
using LaboratoryApp.ViewModels.English.FlashcardFunction.SubWin;

namespace LaboratoryApp.ViewModels.English.FlashcardFunction.UI
{

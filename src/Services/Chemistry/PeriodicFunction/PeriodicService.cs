...
namespace LaboratoryApp.src.Services.Chemistry.PeriodicFunction
{
    public class PeriodicService : IPeriodicService
    {
        ...
        public PeriodicService(IChemistryDataCache chemistryDataCache)
        {
        ...
        /// <returns></returns>
        private Element SetupPeriodBlock(Element element)
        {
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        private Element SetupColorCategory(Element element)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Element> LoadAllElements()
        {
            var elements = _chemistryDataCache.AllElements;
            ...
            {
                SetupPeriodBlock(element);
                SetupColorCategory(element);
            }

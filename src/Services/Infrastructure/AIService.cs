...
namespace LaboratoryApp.src.Services.Infrastructure
{
    public class AIService : IAIService
    {
        ...
        public AIService(IDialogService dialogService)
        {
...
";
            ...
            {
                _dialogService.ShowMessage($"Lỗi khi phân tích phản hồi từ AI: {ex.Message}", "Lỗi JSON", MessageBoxButton.OK, MessageBoxImage.Error);
                return null;
            }
        }

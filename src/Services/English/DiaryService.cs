...
namespace LaboratoryApp.src.Services.English
{
    public class DiaryService : IDiaryService
    {
        ...
        /// <returns></returns>
        public async Task CreateDiaryAsync(string title, bool isPublic, byte[] document)
        {
        ...
        /// <returns></returns>
        public async Task UpdateDiaryAsync(DiaryContent originalDiary, string newTitle, bool newIsPublic, byte[] newDocument)
        {
            originalDiary.Title = newTitle ?? "Untitled";
            originalDiary.IsPublic = newIsPublic;
            originalDiary.ContentBytes = newDocument;

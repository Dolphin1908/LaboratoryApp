...
namespace LaboratoryApp.src.Modules.Tools.English.DictionaryFunction.ViewModels
{
    public class DictionaryViewModel : BaseViewModel, INotifyPropertyChanged
    {
        ...
        public DictionaryViewModel(IDialogService dialogService,
                                   ...
                                   IDictionaryService dictionaryService)
        {
            ...
            SpeechTextCommand = new RelayCommand<string>((p) => !string.IsNullOrWhiteSpace(p), (p) =>
            {
                _speechService.Speak(p);
            });
        ...
        private void SelectResult(DictionarySearchResultDTO selected)
        {
            ...
            {
                _dialogService.ShowMessage("Word not found.");
                return;
            }

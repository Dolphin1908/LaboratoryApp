...
namespace LaboratoryApp.src.Modules.Student.English.DiaryFunction.ViewModels
{
    public class DiaryManagerViewModel : BaseViewModel, IAsyncInitializable
    {
        ...
        private readonly Func<IServiceProvider, IDialogService, IAIService, IDiaryService, IUserProvider, DiaryContent, DiaryDetailViewModel> _diaryDetailvmFactory;
        ...
        public DiaryManagerViewModel(IServiceProvider serviceProvider,
                                     ...
                                     Func<IServiceProvider, IDialogService, IAIService, IDiaryService, IUserProvider, DiaryContent, DiaryDetailViewModel> diaryDetailvmFactory)
        {
            ...
            OpenDiaryDetailCommand = new RelayCommand<object>((p) => p is DiaryContent, (p) =>
            {
                ...
                window.DataContext = _diaryDetailvmFactory(_serviceProvider, _dialogService, _aiService, _diaryService, _userProvider, diary!);
                window.ShowDialog();
